...
- (NSMutableDictionary *)columnNameToIndexMap {
    if (!_columnNameToIndexMap) {
        ...
        for (columnIdx = 0; columnIdx < columnCount; columnIdx++) {
            ...
            if ([_columnNameToIndexMap valueForKey:[[NSString stringWithUTF8String:sqlite3_column_name([_statement statement], columnIdx)] lowercaseString]]!=nil) {
                NSLog(@"%d:%@",columnIdx,[[NSString stringWithUTF8String:sqlite3_column_name([_statement statement], columnIdx)] lowercaseString]);
                continue;                
            }
            ;
